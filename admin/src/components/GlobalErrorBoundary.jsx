...
export class GlobalErrorBoundary extends Component {
    constructor(props) {
        super(props);
        this.state = { hasError: false, error: null, errorInfo: null, sendingReport: false, reportSent: false, detailedError: null };
    }
    ...
    componentDidMount() {
        ...
        window.onerror = (message, source, lineno, colno, error) => {
            // Check if we are already in an error state to avoid loops
