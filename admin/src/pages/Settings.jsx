                ...
                <div className="card-body" style={{ padding: '1.5rem' }}>
                    <form onSubmit={handleSave}>
                        <div style={{
                            ...
                            Generate new keys with: <code>npx web-push generate-vapid-keys --json</code>
                        </div>
                        <div className="form-group">
                            ...
                            <input
                                ...
                                placeholder="BDGveFW_-fccCAIjxV6nWBWe3iRT6UPsoqd5bD4ukjult..."
                                style={{ fontFamily: 'monospace', fontSize: '0.85rem' }}
                            />
                        </div>
                        <div className="form-group">
                            <label className="form-label">VAPID Private Key</label>
                            <input
                                type="password"
                            ...
                            />
                            <div style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)', marginTop: '0.25rem' }}>
                                Keep this key secret. It's stored securely in the database.
                            </div>
                        </div>
                        <div className="form-group" style={{ marginBottom: '1.5rem' }}>
                            <label className="form-label">VAPID Subject</label>
                            <input
                                name="vapid_subject"
                                className="form-input"
