...
> [!IMPORTANT]
> **Privacidad Primero**: Solo usamos tu ubicación para mostrar puntos cercanos y calcular rutas, pero NO guardamos ni compartimos de ninguna forma ninguna información relativa a tu ubicación.
