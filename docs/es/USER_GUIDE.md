...
NestFinder es una aplicación web (PWA) que puedes instalar directamente en tu teléfono sin pasar por la App Store.
...
- **Filtrar**: Toca el icono de embudo para mostrar solo puntos específicos (ej., solo confirmados).
