...
#### 🍏 iOS (iPhone/iPad)
1. Tap the **Share** button (box with an arrow up) in Safari.
2. Scroll down and tap **"Add to Home Screen"**.
3. Tap **Add**.

![Screenshot: iOS Share Menu Add to Home Screen](path/to/ios_install_screenshot.png)
...
![Screenshot: Android Chrome Menu Install App](path/to/android_install_screenshot.png)
...
2. Make sure it is **ON**.
3. In browser (Chrome), tap **Allow** when asked.

### Troubleshooting
If you see a purple banner saying "Enable Your Location", tap the **Enable Location** button.

![Screenshot: Enable Location Banner](path/to/enable_location_banner.png)
...
- **Search**: Type a location in the search bar.
...
![Screenshot: Main Map View](path/to/map_view.png)
...
![Screenshot: Report Point Panel](path/to/report_panel.png)
...
4. Follow the numbered path on the map!

![Screenshot: Route Planner Panel](path/to/route_panel.png)

### Viewing Messages
Check the **Inbox** for updates on points you've reported or subscribed to.

![Screenshot: Inbox Panel](path/to/inbox_panel.png)
